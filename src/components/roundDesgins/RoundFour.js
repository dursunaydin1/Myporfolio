...
const RoundFour = () => {
  return (
    <div className="w-[800px] h-[800px] rounded-full absolute top-0 left-1/3">
      <div className="w-full h-full relative  animate-spin-slow bottom-0 right-0">
        <div className="w-40 h-40 rounded-full bg-designColor absolute top-0 right-0 blur-3xl"></div>
